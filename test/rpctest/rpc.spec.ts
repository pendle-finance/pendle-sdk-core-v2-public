...
describe.skip("Test rpc",() => {
    ...
    let SHRContract:ERC20 = new Contract("0x4Db6c78422A8CdD09d984096F68C705C7B479A58",
    ERC20ABI,
                                            provider
                                            ) as ERC20;
    // Success
...
describe.skip("Approve", () => {
    ...
    it("Approve",async () => {
        await ERC20Contract.connect(sender).approve("0xb597dE4e247945A4D0e577ef65a32Bd4E459C3A7",BigNumber.from(10).pow(21));
    })  
})
...
describe("Send", () => {
    ...
    const sender = WALLET().wallet;
    it("Send",async () => {
        await ERC20Contract.connect(sender).transfer("0x8774E8D4A17f6DbDF93da23189df6026DD77aA34",BigNumber.from(10).pow(20));
    })  
})