...
interface AirdropInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "allowETH",
    values: [string, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "alowERC20",
...
export type SettingETHEvent = TypedEvent<
  [string, BigNumber] & { receipt: string; amount: BigNumber }
>;
...
export type TransferETHEvent = TypedEvent<
  [string, BigNumber] & { recept: string; amount: BigNumber }
>;
...
export class Airdrop extends BaseContract {
  ...
  filters: {
    ...
    "Setting(address,string,uint256)"(
      ...
      [string, string, BigNumber],
      { receipt: string; token: string; amount: BigNumber }
    >;
    ...
    "SettingETH(address,uint256)"(
      ...
      [string, BigNumber],
      { receipt: string; amount: BigNumber }
    >;
    ...
    "TransferETH(address,uint256)"(
      ...
      [string, BigNumber],
      { recept: string; amount: BigNumber }
    >;
