...
declare module 'hardhat/types/runtime' {
    interface HardhatEthersHelpers extends HardhatEthersHelpersBase {
        ...
        getContractAt(name: 'Airdrop', address: string, signer?: ethers.Signer): Promise<Contracts.Airdrop>;
        ...
        getContractAt(name: 'TestContract', address: string, signer?: ethers.Signer): Promise<Contracts.TestContract>;
