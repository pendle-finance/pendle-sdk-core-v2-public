...
export type SwapExactTokenForPtRouteData = {
    netPtOut: BN;
    netSyFee: BN;
    priceImpact: BN;
...
> {
    ...
    override routeWithBulkSeller(withBulkSeller: boolean = true): SwapExactTokenForPtRoute<T> {
    ...
    protected override async previewWithRouterStatic(): Promise<SwapExactTokenForPtRouteData | undefined> {
        ...
        const data = await this.routerStaticCall.swapExactBaseTokenForPtStatic(
            this.market,
            this.tokenMintSy,
