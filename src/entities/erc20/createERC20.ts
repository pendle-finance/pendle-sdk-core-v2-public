...
import { isNativeToken, Address, ChainId, CHAIN_ID_MAPPING, isSameAddress, toAddress } from '../../common';
...
export function createERC20(tokenAddress: Address, config: ERC20Config): ERC20Like {
    if (
        ...
        isSameAddress('0x5402B5F40310bDED796c7D0F3FF6683f5C0cFfdf', tokenAddress)
    ) {
