...
export type PendleContractErrorMessageHandler = {
    ...
    CallThenRevertError: (success: undefined, res: undefined) => string;
    ...
    FarmNotFound: () => string;
    FluxLendingError: (errCode: BN) => string;
    Forbidden: () => string;
    ...
    MFNotPendleMarket: (addr: Address) => string;
    ...
    MarketFactoryOverriddenFeeTooHigh: (overriddenFee: BN, marketLnFeeRateRoot: BN) => string;
    ...
    SYZeroRedeem: () => string;
    SimulationResults: (success: undefined, res: undefined) => string;
    StaderMaxDepositExceed: (amountToDeposit: BN, maxDeposit: BN) => string;
    StaderMinDepositUnreached: (amountToDeposit: BN, minDeposit: BN) => string;
