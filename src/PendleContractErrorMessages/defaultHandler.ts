...
export const defaultPendleContractErrorMessageHandler: PendleContractErrorMessageHandler = {
    ...
    MarketInsufficientScyReceived: (...args) => `Got MarketInsufficientScyReceived error (${joinArgs(args)})`,
    ...
    RouterExceededLimitScyIn: (...args) => `Got RouterExceededLimitScyIn error (${joinArgs(args)})`,
    ...
    RouterInsufficientScyOut: (...args) => `Got RouterInsufficientScyOut error (${joinArgs(args)})`,
    RouterInsufficientScyRepay: (...args) => `Got RouterInsufficientScyRepay error (${joinArgs(args)})`,
    ...
    SCYCurve3crvPoolNotFound: (...args) => `Got SCYCurve3crvPoolNotFound error (${joinArgs(args)})`,
    SCYCurveInvalidPid: (...args) => `Got SCYCurveInvalidPid error (${joinArgs(args)})`,
    SCYInsufficientSharesOut: (...args) => `Got SCYInsufficientSharesOut error (${joinArgs(args)})`,
    SCYInsufficientTokenOut: (...args) => `Got SCYInsufficientTokenOut error (${joinArgs(args)})`,
    SCYInvalidTokenIn: (...args) => `Got SCYInvalidTokenIn error (${joinArgs(args)})`,
    SCYInvalidTokenOut: (...args) => `Got SCYInvalidTokenOut error (${joinArgs(args)})`,
    SCYQiTokenBorrowRateTooHigh: (...args) => `Got SCYQiTokenBorrowRateTooHigh error (${joinArgs(args)})`,
    SCYQiTokenMintFailed: (...args) => `Got SCYQiTokenMintFailed error (${joinArgs(args)})`,
    SCYQiTokenRedeemFailed: (...args) => `Got SCYQiTokenRedeemFailed error (${joinArgs(args)})`,
    SCYQiTokenRedeemRewardsFailed: (...args) => `Got SCYQiTokenRedeemRewardsFailed error (${joinArgs(args)})`,
    SCYZeroDeposit: (...args) => `Got SCYZeroDeposit error (${joinArgs(args)})`,
    SCYZeroRedeem: (...args) => `Got SCYZeroRedeem error (${joinArgs(args)})`,
    ...
    YCNoFloatingScy: (...args) => `Got YCNoFloatingScy error (${joinArgs(args)})`,
    ...
    YieldContractInsufficientScy: (...args) => `Got YieldContractInsufficientScy error (${joinArgs(args)})`,
